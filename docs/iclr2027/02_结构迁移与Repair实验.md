...
当前Progressive配方失败，但不代表所有模块替换方法失败。Teacher Assistant随第一阶段训练增强而同时改善SR和多样性，说明`4×48 assistant`质量是主要瓶颈之一。
...
- Assistant 1000＋Student 300双阶段评估；
- Assistant 700＋`K=4, λ=0.1`＋Student 300双阶段评估。
